  ...
  function documentClick(e) {
    if (self.isOpen && !self.config.inline) {
      ...
      if (lostFocus && isIgnored) {
        if (self.config.allowInput) {
          self.setDate(self._input.value, true, self.config.altInput ? self.config.altFormat : self.config.dateFormat);
        }
...
var buttonStart = document.querySelector('button[data-start]');
var days = document.querySelector('span[data-days]');
var hours = document.querySelector('span[data-hours]');
var minutes = document.querySelector('span[data-minutes]');
var seconds = document.querySelector('span[data-seconds]');
...
function timeCounter() {
  var time = selectedDate.getTime() - currentDate.getTime();
